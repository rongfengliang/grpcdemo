...
type UserLoginClient interface {
	...
	LongMessage(ctx context.Context, opts ...grpc.CallOption) (UserLogin_LongMessageClient, error)
}
...
func (c *userLoginClient) LongMessage(ctx context.Context, opts ...grpc.CallOption) (UserLogin_LongMessageClient, error) {
...
func (x *userLoginLongMessageClient) Send(m *QueryRequst) error {
...
type UserLoginServer interface {
	...
	LongMessage(UserLogin_LongMessageServer) error
}
...
func _UserLogin_LongMessage_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(UserLoginServer).LongMessage(&userLoginLongMessageServer{stream})
}

type UserLogin_LongMessageServer interface {
	Send(*MessageResponse) error
	Recv() (*QueryRequst, error)
	grpc.ServerStream
}
...
func (x *userLoginLongMessageServer) Recv() (*QueryRequst, error) {
	m := new(QueryRequst)
